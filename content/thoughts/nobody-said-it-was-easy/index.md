...
different modules. And students wanted more technical depth, not less.
...
Rather than losing myself in the enormity of it all, I felt I needed to
return to my roots and be a scientist. Run an experiment. See what
happens.

So, like I am fond of telling others, I sat down with Claude and started
a conversation.

## The Experiment

Not one prompt, but an extended back-and-forth over about two hours
...
spent reading and thinking, not typing.

I fed it the current course structure and anonymized student
evaluations, and we worked through the problem together.{% sidenote
"sn-evals" "Student evaluations are anonymized when faculty receive
them. No student personally identifiable information was used at any
point in this process." %} The AI asked clarifying questions before
...
The conversation was genuinely collaborative. The AI proposed
...
respond to that feedback systematically rather than piecemeal.{%
sidenote "sn-privacy" "AI tools were configured with appropriate privacy
...
institutional policies and tool configurations." %}

## What We Produced

Over our conversation, we worked through a comprehensive redesign scope.
Not just which videos need updating, but the full architecture.

We rewrote course-level and MOOC-level learning outcomes. We
...
happen first and what can wait.{% sidenote "sn-structure" "Specific
...
Teaching and Learning staff concrete data for workload planning." %}
...
kept it and found space elsewhere.

The output was a comprehensive scope document with learning outcomes,
...
of meetings between faculty and Teaching and Learning staff.

## What I Couldn't Do With It

I had a full revision scope, and a rough estimate for the resources
required. But the course was going to be taught again in weeks not
months. I didn't have the time or resources to make these changes.
...
structure across all modules so students know what to expect." %} The
...
focus on today's applications.

Cheng had a critical insight that shaped the whole approach. My initial
...
In keeping with the scientific mindset, I also used Claude to help draft
...
This course launches again soon. So I don't know yet whether the module
...
prioritize the real revision.

## Then I Realized What This Could Mean

I did this experiment out of curiosity, driven by student feedback, over
a few days. The full implications, however, didn't hit me until later.

What if Teaching and Learning staff did this *for* faculty?

Feed the AI a current syllabus, anonymized student evaluations, and
...
That flips the traditional workflow. T&L staff move from reactive
...
The traditional dynamic can be painful for everyone. Faculty want to
change everything. We're academics, of course we do. T&L staff push back
because of capacity constraints. Both sides may end up frustrated.

What if T&L staff instead said: "We have capacity for a 25% revision
...
gap: module guides, updated assessments, and refreshed live sessions."
...
To be clear, this scope document is a snapshot in time, not a finished
...
hope it ages well. You can revisit it as conditions change.

This started with student feedback and curiosity. It ended with
...
itself revealed a workflow that could matter well beyond my one course.

Faculty expertise and judgment are still essential. AI proposes, humans
...
But the tools exist now. The question is whether our higher ed workflows
will adapt to use them.
