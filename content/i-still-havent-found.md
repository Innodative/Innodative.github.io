...
seeing—it's getting others to see what I do.

For years, I tried to communicate the future in my head. I would
explain, hand-wave, and argue about what I saw clearly. And I would
watch people nod politely without necessarily understanding.

The problem wasn't them. It was me. Specifically, my communication. I'm
...
This struggle reminds me of a U2 song{% marginnote "mn-u2" "[U2, I Still
Haven't Found What I'm Looking
For](https://www.youtube.com/watch?v=e3-5YC_oHjE)" %}: "I have climbed
the highest mountains, I have run through the fields ..." but I still
hadn't found a way to help them see what I could see.

## SEEING IS BELIEVING

In late 2021, I was fortunate to work with Jake Kinsey, who had the
insight to create a demo. We made an AI-generated avatar of me speaking.
One version in English{% sidenotevideo "sn-english-demo" "RqbrNc00r1c"
"Original Avatar demo from November 2021 in English. Notice the quality
for 2021, impressive, but clearly synthetic." %}, a second in Mandarin{%
sidenotevideo "sn-mandarin-demo" "gzJc1Rmho-U" "Original Avatar demo
from November 2021 in Mandarin. Impressive but clearly not fluent." %}.
...
movements to sync with the new audio.

Of course, I don't speak Mandarin; however, even I could tell my
...
I first showed this demo to Dean Brown. When I saw his reaction, I knew
immediately this demo worked. This was what had been in my head, but now
made tangible. Something people could actually see and share.

This seemingly simple demonstration helped shift our college's thinking
...
In general, people's reactions were similar: surprise, curiosity, some
...
language, and we could easily bring others along by showing them.

This is how you really drive institutional change. Not through position
papers, but through demonstrations that shift the frame of what people
believe is possible.

For a long time, visual evidence was enough. Seeing was believing. A
video of something meant that something happened. Presence, real visual
and audible presence, carried inherent authority.

But technology does not stand still. And neither does the meaning of
what we see.
...
"sn-first-production" "WsOKlelCpd4" "The first production avatar, a
significant step up from the original 2021 demo." %} in my new online
course on *Emerging Technology and Disruption*{% sidenote "sn-media"
"Links to [media coverage](https://innodative.com/media/) of our avatar
work." %}. The avatar wasn't perfect{% sidenote "sn-mom" "My mother
immediately spotted a flaw: it mispronounced my last name." %}, but it
was actionable.

A year later, with help from the Teaching and Learning staff at Gies, we
built a second, and much improved avatar that we used to record almost
all of the videos for a new online course entitled *AI for Business*{%
sidenote "sn-award" "The full teaching and learning team won a
college-level award for their work adopting AI for the creation of this
new, online course." %}. To maintain consistency, I wore the same outfit
for my live-recorded videos and for the avatar training videos. There
were no obvious visual cues that might indicate a difference.

But, to be clear, we were transparent about the process. We even created
...
got this video."{% sidenote "sn-side-by-side" "The side-by-side
...
avatar rights and expectations.{% sidenote "sn-mou" "The MOU isn't
perfect, but it was designed to be updated over time as we learn more
about what works and what doesn't." %} Together, we were learning in
real time what policies this technology required.

When I first taught *AI for Business* in Spring 2025, students had
...
like the fictional news anchor, the avatar reads whatever it is given.

The variation in students' responses was interesting, but it didn't
...
ask questions? What if the avatar could respond?

## THE TECTONIC SHIFT

The next step in this journey took place in the fall of 2025, when my
graduate student Xinyao Qian and I built our first interactive avatar
using the [HeyGen](https://labs.heygen.com/interactive-avatar?tab=demo)
platform{% marginnote "mn-heygen" "Heygen is an American AI startup with
...
interactive avatars." %}. Four years after my first avatar demonstration
...
but like the first demo, this one had flaws{% sidenotevideo 
"sn-interactive" "H0l9xSYFVIA" "Interactive avatar responding to 
...
dumb</a>: boundary testing" %}. The delay between question and response
is too long; this version is essentially unusable. Yet, just like the
first demo, this new demo provides a glimpse of the future.

The new Professor Robert Burgundy won't get tired, won't get sick, is
...
In four short years, we went from hand crafted manipulated video to
...
look like engineering challenges rather than fundamental limitations.

It was just another demo to the dean, but this time something felt
fundamentally different. Not fear, but an awareness that the future will
be different.

## AUTHENTICITY OR NOT?

For centuries, seeing has been believing{% marginnote "mn-seeing" "This
...
led to the phrase 'Doubting Thomas.'" %}. Visual media implied trust;
interactivity implied humanity. This new demo, however, implied
something different.

***In a world of synthetic media, authenticity must be external to the
content; it can no longer be implied.***

We can now build interactive, synthetic content. But we don't know how
to define authenticity.

How do I confirm reality? Or confirm approved synthetic creations? How
do you know what to trust when visual and audible evidence, even
interactive evidence, is no longer sufficient?

As Bono sang, "I still haven't found what I'm looking for."

Each new avatar gets me closer to conveying the future I see—and reveals
...
interactive synthetic media becomes commonplace.

These aren't abstract questions. Professor Robert Burgundy is already
...
optional. But it must be intentional.

The future is visible. The question now is whether we are prepared to
interpret what we see.

---

*This article was developed with AI assistance for research, outlining,
