Title: Accelerating towards Obsolescence
Date: 2026-05-01
Category: Thoughts 
...
I see journalism following the same binary paths. Wired published a near-blanket ban{% marginnote 'wired-ai' "Wired's policy bars AI-generated or AI-edited text and AI-generated images, with narrow carve-outs for headline suggestions and idea brainstorming. <a href='https://www.wired.com/story/how-wired-will-use-generative-ai-tools/'>How WIRED Will Use Generative AI Tools</a>, by Gideon Lichfield." %} on AI-generated text in stories, with carve-outs for things like headline brainstorming and story idea generation.
